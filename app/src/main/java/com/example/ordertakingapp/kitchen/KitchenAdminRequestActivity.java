...
import com.example.ordertakingapp.adapter.KitchenAdminRequestListAdapter;
...
public class KitchenAdminRequestActivity extends AppCompatActivity {
    ...
    private void notificationGetlistResponseCall() {
        ...
        Call<KitchenAdminRequestListResponse> call = ApiService.kitchenAdminRequestListResponse(RestUtils.getContentType(),kitchenAdminRequestListRequest());
    ...
    private KitchenAdminRequestListRequest kitchenAdminRequestListRequest() {
        ...
        kitchenAdminRequestListRequest.setWaiter_id(userid);
    ...
    private void setView() {
        ...
        KitchenAdminRequestListAdapter kitchenAdminRequestListAdapter = new KitchenAdminRequestListAdapter(getApplicationContext(), kitchenAdminResponseList);
        rv_admin_request_list.setAdapter(kitchenAdminRequestListAdapter);
