...
public class AdminOrderDetailListActivity extends AppCompatActivity implements View.OnClickListener {

    private String TAG  = "AdminOrderDetailListActivity";
    Spinner spin_order;
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()){
            case R.id.back_icon:
                startActivity(new Intent(getApplicationContext(), AdminOrderListActivity.class));
                finish();
                break;
        }
    ...
    private void showCompleteStatusAlert() {
        ...
        try {
            dialog = new Dialog(AdminOrderDetailListActivity.this);
