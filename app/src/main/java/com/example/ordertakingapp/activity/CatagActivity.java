...
import com.example.ordertakingapp.adapter.MyAdapter;
...
import com.example.ordertakingapp.adapter.OverViewItemListAdapter;
import com.example.ordertakingapp.api.APIClient;
import com.example.ordertakingapp.api.RestApiInterface;
import com.example.ordertakingapp.interfaces.AddItemListener;
import com.example.ordertakingapp.interfaces.CatagListListener;
import com.example.ordertakingapp.interfaces.RemoveItemListener;
                ...
                if (response.body() != null) {
                    if ( 200 == response.body().getCode()) {
                        if(response.body().getData() != null && response.body().getData().size()>0){
                            Log.w(TAG,"response : "+new Gson().toJson(response.body().getData()));
