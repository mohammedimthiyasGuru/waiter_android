...
public class TableItemListAdapter extends RecyclerView.Adapter<TableItemListAdapter.KitchenHolder> {

    private String TAG = "TableItemListAdapter";
    Context context;
    List<OrderDetailsResponse.DataBean.ItemDetailBean> item_detail;

    public TableItemListAdapter(Context context, List<OrderDetailsResponse.DataBean.ItemDetailBean> item_detail) {
