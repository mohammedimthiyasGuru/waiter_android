...
public class AdminOrderDetailListAdapter extends RecyclerView.Adapter<AdminOrderDetailListAdapter.KitchenHolder> {

    private String TAG = "WaiterOrderDetailListAdapter";
    Context context;
    List<OrderDetailsResponse.DataBean.ItemDetailBean> item_detail;

    public AdminOrderDetailListAdapter(Context context, List<OrderDetailsResponse.DataBean.ItemDetailBean> item_detail) {
