...
public class AdminOrderListAdapter extends RecyclerView.Adapter<AdminOrderListAdapter.KitchenHolder> {

    private String TAG = "AdminOrderListAdapter";
    Context context;
    List<KitchenDashoboardListResponse.DataBean> data;
    OrderListClickListener orderListClickListener;

    public AdminOrderListAdapter(Context context, List<KitchenDashoboardListResponse.DataBean> data, OrderListClickListener orderListClickListener) {
    ...
    public void onBindViewHolder(@NonNull KitchenHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, AdminOrderDetailListActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
