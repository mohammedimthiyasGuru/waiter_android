...
public class ChefAdminRequestListAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private  String TAG = "ChefAdminRequestListAdapter";
    ...
    public ChefAdminRequestListAdapter(Context context, List<KitchenAdminRequestListResponse.DataBean> kitchenAdminResponseList) {
