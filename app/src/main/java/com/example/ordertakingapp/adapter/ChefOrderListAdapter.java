...
import com.example.ordertakingapp.activity.AdminOrderDetailListActivity;
import com.example.ordertakingapp.activity.ChefOrderDetailListActivity;
...
public class ChefOrderListAdapter extends RecyclerView.Adapter<ChefOrderListAdapter.KitchenHolder> {

    private String TAG = "ChefOrderListAdapter";
    Context context;
    List<KitchenDashoboardListResponse.DataBean> data;
    OrderListClickListener orderListClickListener;

    public ChefOrderListAdapter(Context context, List<KitchenDashoboardListResponse.DataBean> data, OrderListClickListener orderListClickListener) {
    ...
    public void onBindViewHolder(@NonNull KitchenHolder holder, int position) {
        ...
        {
            holder.txt_status.setText(data.get(position).getChef_status());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ChefOrderDetailListActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
