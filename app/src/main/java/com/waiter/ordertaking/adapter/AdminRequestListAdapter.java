...
public class AdminRequestListAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private  String TAG = "AdminRequestListAdapter";
    private Context context;

    AdminRequestListResponse.DataBean currentItem;
    ...
    public AdminRequestListAdapter(Context context, List<AdminRequestListResponse.DataBean> kitchenAdminResponseList) {
