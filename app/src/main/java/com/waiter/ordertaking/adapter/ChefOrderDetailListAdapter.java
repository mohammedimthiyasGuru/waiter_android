...
public class ChefOrderDetailListAdapter extends RecyclerView.Adapter<ChefOrderDetailListAdapter.KitchenHolder> {

    private String TAG = "ChefOrderDetailListAdapter";
    Context context;
    List<OrderDetailsResponse.DataBean.ItemDetailBean> item_detail;

    public ChefOrderDetailListAdapter(Context context, List<OrderDetailsResponse.DataBean.ItemDetailBean> item_detail) {
