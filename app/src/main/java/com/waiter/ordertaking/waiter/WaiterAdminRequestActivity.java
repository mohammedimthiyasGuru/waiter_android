...
import com.waiter.ordertaking.adapter.WaiterAdminRequestListAdapter;
import com.waiter.ordertaking.api.APIClient;
import com.waiter.ordertaking.api.RestApiInterface;
import com.waiter.ordertaking.kitchen.KitchenAdminRequestActivity;
...
public class WaiterAdminRequestActivity extends AppCompatActivity {
                ...
                if (response.body() != null) {
                    if(response.body().getCode() == 200){
                        ...
                        if(response.body().getData() != null && response.body().getData().size()>0){
                            ...
                            txt_norecord.setText("No new requests");
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(WaiterAdminRequestActivity.this, WaiterActivity.class));
