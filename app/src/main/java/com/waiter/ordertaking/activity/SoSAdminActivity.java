...
public class SoSAdminActivity extends AppCompatActivity implements SoSCallListener {
        ...
        if (new ConnectionDetector(getApplicationContext()).isNetworkAvailable(getApplicationContext())) {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(SoSAdminActivity.this, new String[]{Manifest.permission.CALL_PHONE},REQUEST_PHONE_CALL);
                }
                else
                {
                    gotoPhone();
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(SoSAdminActivity.this, DashBoardActivity.class));
                ...
                if (response.body() != null) {
                    if(response.body().getCode() == 200){
                        ...
                        if(sosList != null && sosList.size()>0){
                            ...
                            SOSAdapter sosAdapter = new SOSAdapter(getApplicationContext(), sosList, SoSAdminActivity.this);
